...
`,[y("splitor",`
 ...
 `),L("checked",{color:"var(--n-button-text-color-hover)"})]),z("focus",[H("&:not(:active)",[y("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),z("checked",`
 ...
 `)])]);function Te(e,o,t){var r;const a=[];let v=!1;for(let i=0;i<e.length;++i){const c=e[i],h=(r=c.type)===null||r===void 0?void 0:r.name;h==="RadioButton"&&(v=!0);const d=c.props;if(h!=="RadioButton"){a.push(c);continue}if(i===0)a.push(c);else{const s=a[a.length-1].props,b=o===s.value,f=s.disabled,m=o===d.value,p=d.disabled,k=(b?2:0)+(f?0:1),w=(m?2:0)+(p?0:1),F={[`${t}-radio-group__splitor--disabled`]:f,[`${t}-radio-group__splitor--checked`]:b},$={[`${t}-radio-group__splitor--disabled`]:p,[`${t}-radio-group__splitor--checked`]:m},B=k<w?$:F;a.push(_("div",{class:[`${t}-radio-group__splitor`,B]}),c)}}return{children:a,isButtonGroup:v}}const De=Object.assign(Object.assign({},J.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),Ne=E({name:"RadioGroup",props:De,setup(e){const o=S(null),{mergedSizeRef:t,mergedDisabledRef:r,nTriggerFormChange:a,nTriggerFormInput:v,nTriggerFormBlur:i,nTriggerFormFocus:c}=Z(e),{mergedClsPrefixRef:h,inlineThemeDisabled:d,mergedRtlRef:s}=Q(e),b=J("Radio","-radio-group",Ve,Fe,e,h),f=S(e.defaultValue),m=W(e,"value"),p=q(m,f);function k(l){const{onUpdateValue:u,"onUpdate:value":g}=e;u&&T(u,l),g&&T(g,l),f.value=l,a(),v()}function w(l){const{value:u}=o;u&&(u.contains(l.relatedTarget)||c())}function F(l){const{value:u}=o;u&&(u.contains(l.relatedTarget)||i())}xe(Y,{mergedClsPrefixRef:h,nameRef:W(e,"name"),valueRef:p,disabledRef:r,mergedSizeRef:t,doUpdateValue:k});const $=ge("Radio",s,h),B=M(()=>{const{value:l}=t,{common:{cubicBezierEaseInOut:u},self:{buttonBorderColor:g,buttonBorderColorActive:D,buttonBorderRadius:N,buttonBoxShadow:ee,buttonBoxShadowFocus:oe,buttonBoxShadowHover:te,buttonColor:re,buttonColorActive:ae,buttonTextColor:ne,buttonTextColorActive:ie,buttonTextColorHover:se,opacityDisabled:le,[O("buttonHeight",l)]:de,[O("fontSize",l)]:ue}}=b.value;return{"--n-font-size":ue,"--n-bezier":u,"--n-button-border-color":g,"--n-button-border-color-active":D,"--n-button-border-radius":N,"--n-button-box-shadow":ee,"--n-button-box-shadow-focus":oe,"--n-button-box-shadow-hover":te,"--n-button-color":re,"--n-button-color-active":ae,"--n-button-text-color":ne,"--n-button-text-color-hover":se,"--n-button-text-color-active":ie,"--n-height":de,"--n-opacity-disabled":le}}),n=d?me("radio-group",M(()=>t.value[0]),B,e):void 0;return{selfElRef:o,rtlEnabled:$,mergedClsPrefix:h,mergedValue:p,handleFocusout:F,handleFocusin:w,cssVars:d?void 0:B,themeClass:n==null?void 0:n.themeClass,onRender:n==null?void 0:n.onRender}},render(){var e;const{mergedValue:o,mergedClsPrefix:t,handleFocusin:r,handleFocusout:a}=this,{children:v,isButtonGroup:i}=Te(pe(Be(this)),o,t);return(e=this.onRender)===null||e===void 0||e.call(this),_("div",{onFocusin:r,onFocusout:a,ref:"selfElRef",class:[`${t}-radio-group`,this.rtlEnabled&&`${t}-radio-group--rtl`,this.themeClass,i&&`${t}-radio-group--button-group`],style:this.cssVars},v)}}),Ue={class:"share-scope"},He={key:0,class:"role-box"},Pe={key:1,class:"role-hint"},Ae={key:2,class:"role-hint"},We=E({__name:"ShareScopeSelector",props:{shared:{type:Boolean},shareWith:{}},emits:["update:shared","update:shareWith"],setup(e,{emit:o}){const t=e,r=o,a=S("private"),v=[{label:"操作员",value:"operator"},{label:"普通用户",value:"user"},{label:"访客",value:"viewer"}],i=S(!1);function c(){if(i.value){i.value=!1;return}a.value=t.shared?"all":t.shareWith&&t.shareWith.length?"roles":"private"}K(()=>[t.shared,t.shareWith],c,{immediate:!0}),K(a,d=>{d==="all"?(i.value=!0,r("update:shared",!0),r("update:shareWith",[])):d==="private"?(i.value=!0,r("update:shared",!1),r("update:shareWith",[])):(i.value=!0,r("update:shared",!1))});function h(d){r("update:shareWith",d)}return(d,s)=>(I(),V("div",Ue,[x(C(Ne),{value:a.value,"onUpdate:value":s[0]||(s[0]=b=>a.value=b),size:"small"},{default:R(()=>[x(C(X),null,{default:R(()=>[x(C(A),{value:"private"},{default:R(()=>[...s[1]||(s[1]=[P("私有（仅自己）",-1)])]),_:1}),x(C(A),{value:"all"},{default:R(()=>[...s[2]||(s[2]=[P("共享给所有人",-1)])]),_:1}),x(C(A),{value:"roles"},{default:R(()=>[...s[3]||(s[3]=[P("按角色共享",-1)])]),_:1})]),_:1})]),_:1},8,["value"]),a.value==="roles"?(I(),V("div",He,[x(C(ze),{value:e.shareWith,"onUpdate:value":h},{default:R(()=>[x(C(X),null,{default:R(()=>[(I(),V(Ce,null,Re(v,b=>x(C(_e),{key:b.value,value:b.value},{default:R(()=>[P(Se(b.label),1)]),_:2},1032,["value"])),64))]),_:1})]),_:1},8,["value"]),s[4]||(s[4]=ke("div",{class:"role-hint"},"选中的角色成员可见 / 可使用（仅创建者可编辑）",-1))])):a.value==="all"?(I(),V("div",Pe,"所有登录用户可见 / 可使用（仅创建者可编辑）")):(I(),V("div",Ae,"仅你自己可见 / 可管理"))]))}}),Le=ye(We,[["__scopeId","data-v-b1c2d20d"]]);export{Ne as N,Le as S,A as a};
