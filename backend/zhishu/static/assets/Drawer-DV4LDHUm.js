import{f as Y,an as U,g as u,c2 as fe,T as _,s as be,bB as me,a$ as N,e as B,u as V,b9 as ge,aU as ve,w as we,c as pe,c3 as ye,y as w,l as ze,bC as q,c4 as $e,F as T,J as xe,E as Se,I as Be,p as i,c5 as H,m as c,n as g,M as $,bm as Ce,bF as Ee,bE as ke,bH as Re,t as K,P as L,c6 as Fe,x as Te,c7 as He,Q as x,c8 as Me,S as j,z as X}from"./index-BKMssSE2.js";const Ie=Y({name:"NDrawerContent",inheritAttrs:!1,props:{blockScroll:Boolean,show:{type:Boolean,default:void 0},displayDirective:{type:String,required:!0},placement:{type:String,required:!0},contentClass:String,contentStyle:[Object,String],nativeScrollbar:{type:Boolean,required:!0},scrollbarProps:Object,trapFocus:{type:Boolean,default:!0},autoFocus:{type:Boolean,default:!0},showMask:{type:[Boolean,String],required:!0},maxWidth:Number,maxHeight:Number,minWidth:Number,minHeight:Number,resizable:Boolean,onClickoutside:Function,onAfterLeave:Function,onAfterEnter:Function,onEsc:Function},setup(e){const o=B(!!e.show),t=B(null),p=ze(q);let b=0,S="",f=null;const y=B(!1),v=B(!1),C=w(()=>e.placement==="top"||e.placement==="bottom"),{mergedClsPrefixRef:M,mergedRtlRef:I}=V(e),O=ge("Drawer",I,M),k=r,D=n=>{v.value=!0,b=C.value?n.clientY:n.clientX,S=document.body.style.cursor,document.body.style.cursor=C.value?"ns-resize":"ew-resize",document.body.addEventListener("mousemove",m),document.body.addEventListener("mouseleave",k),document.body.addEventListener("mouseup",r)},R=()=>{f!==null&&(window.clearTimeout(f),f=null),v.value?y.value=!0:f=window.setTimeout(()=>{y.value=!0},300)},W=()=>{f!==null&&(window.clearTimeout(f),f=null),y.value=!1},{doUpdateHeight:A,doUpdateWidth:P}=p,E=n=>{const{maxWidth:a}=e;if(a&&n>a)return a;const{minWidth:d}=e;return d&&n<d?d:n},F=n=>{const{maxHeight:a}=e;if(a&&n>a)return a;const{minHeight:d}=e;return d&&n<d?d:n};function m(n){var a,d;if(v.value)if(C.value){let h=((a=t.value)===null||a===void 0?void 0:a.offsetHeight)||0;const z=b-n.clientY;h+=e.placement==="bottom"?z:-z,h=F(h),A(h),b=n.clientY}else{let h=((d=t.value)===null||d===void 0?void 0:d.offsetWidth)||0;const z=b-n.clientX;h+=e.placement==="right"?z:-z,h=E(h),P(h),b=n.clientX}}function r(){v.value&&(b=0,v.value=!1,document.body.style.cursor=S,document.body.removeEventListener("mousemove",m),document.body.removeEventListener("mouseup",r),document.body.removeEventListener("mouseleave",k))}ve(()=>{e.show&&(o.value=!0)}),we(()=>e.show,n=>{n||r()}),pe(()=>{r()});const s=w(()=>{const{show:n}=e,a=[[N,n]];return e.showMask||a.push([$e,e.onClickoutside,void 0,{capture:!0}]),a});function l(){var n;o.value=!1,(n=e.onAfterLeave)===null||n===void 0||n.call(e)}return ye(w(()=>e.blockScroll&&o.value)),T(xe,t),T(Se,null),T(Be,null),{bodyRef:t,rtlEnabled:O,mergedClsPrefix:p.mergedClsPrefixRef,isMounted:p.isMountedRef,mergedTheme:p.mergedThemeRef,displayed:o,transitionName:w(()=>({right:"slide-in-from-right-transition",left:"slide-in-from-left-transition",top:"slide-in-from-top-transition",bottom:"slide-in-from-bottom-transition"})[e.placement]),handleAfterLeave:l,bodyDirectives:s,handleMousedownResizeTrigger:D,handleMouseenterResizeTrigger:R,handleMouseleaveResizeTrigger:W,isDragging:v,isHoverOnResizeTrigger:y}},render(){const{$slots:e,mergedClsPrefix:o}=this;return this.displayDirective==="show"||this.displayed||this.show?U(u("div",{role:"none"},u(fe,{disabled:!this.showMask||!this.trapFocus,active:this.show,autoFocus:this.autoFocus,onEsc:this.onEsc},{default:()=>u(_,{name:this.transitionName,appear:this.isMounted,onAfterEnter:this.onAfterEnter,onAfterLeave:this.handleAfterLeave},{default:()=>U(u("div",be(this.$attrs,{role:"dialog",ref:"bodyRef","aria-modal":"true",class:[`${o}-drawer`,this.rtlEnabled&&`${o}-drawer--rtl`,`${o}-drawer--${this.placement}-placement`,this.isDragging&&`${o}-drawer--unselectable`,this.nativeScrollbar&&`${o}-drawer--native-scrollbar`]}),[this.resizable?u("div",{class:[`${o}-drawer__resize-trigger`,(this.isDragging||this.isHoverOnResizeTrigger)&&`${o}-drawer__resize-trigger--hover`],onMouseenter:this.handleMouseenterResizeTrigger,onMouseleave:this.handleMouseleaveResizeTrigger,onMousedown:this.handleMousedownResizeTrigger}):null,this.nativeScrollbar?u("div",{class:[`${o}-drawer-content-wrapper`,this.contentClass],style:this.contentStyle,role:"none"},e):u(me,Object.assign({},this.scrollbarProps,{contentStyle:this.contentStyle,contentClass:[`${o}-drawer-content-wrapper`,this.contentClass],theme:this.mergedTheme.peers.Scrollbar,themeOverrides:this.mergedTheme.peerOverrides.Scrollbar}),e)]),this.bodyDirectives)})})),[[N,this.displayDirective==="if"||this.displayed||this.show]]):null}}),{cubicBezierEaseIn:Oe,cubicBezierEaseOut:De}=H;function We({duration:e="0.3s",leaveDuration:o="0.2s",name:t="slide-in-from-bottom"}={}){return[i(`&.${t}-transition-leave-active`,{transition:`transform ${o} ${Oe}`}),i(`&.${t}-transition-enter-active`,{transition:`transform ${e} ${De}`}),i(`&.${t}-transition-enter-to`,{transform:"translateY(0)"}),i(`&.${t}-transition-enter-from`,{transform:"translateY(100%)"}),i(`&.${t}-transition-leave-from`,{transform:"translateY(0)"}),i(`&.${t}-transition-leave-to`,{transform:"translateY(100%)"})]}const{cubicBezierEaseIn:Ae,cubicBezierEaseOut:Pe}=H;function Ue({duration:e="0.3s",leaveDuration:o="0.2s",name:t="slide-in-from-left"}={}){return[i(`&.${t}-transition-leave-active`,{transition:`transform ${o} ${Ae}`}),i(`&.${t}-transition-enter-active`,{transition:`transform ${e} ${Pe}`}),i(`&.${t}-transition-enter-to`,{transform:"translateX(0)"}),i(`&.${t}-transition-enter-from`,{transform:"translateX(-100%)"}),i(`&.${t}-transition-leave-from`,{transform:"translateX(0)"}),i(`&.${t}-transition-leave-to`,{transform:"translateX(-100%)"})]}const{cubicBezierEaseIn:Ne,cubicBezierEaseOut:Le}=H;function je({duration:e="0.3s",leaveDuration:o="0.2s",name:t="slide-in-from-right"}={}){return[i(`&.${t}-transition-leave-active`,{transition:`transform ${o} ${Ne}`}),i(`&.${t}-transition-enter-active`,{transition:`transform ${e} ${Le}`}),i(`&.${t}-transition-enter-to`,{transform:"translateX(0)"}),i(`&.${t}-transition-enter-from`,{transform:"translateX(100%)"}),i(`&.${t}-transition-leave-from`,{transform:"translateX(0)"}),i(`&.${t}-transition-leave-to`,{transform:"translateX(100%)"})]}const{cubicBezierEaseIn:Xe,cubicBezierEaseOut:Ye}=H;function _e({duration:e="0.3s",leaveDuration:o="0.2s",name:t="slide-in-from-top"}={}){return[i(`&.${t}-transition-leave-active`,{transition:`transform ${o} ${Xe}`}),i(`&.${t}-transition-enter-active`,{transition:`transform ${e} ${Ye}`}),i(`&.${t}-transition-enter-to`,{transform:"translateY(0)"}),i(`&.${t}-transition-enter-from`,{transform:"translateY(-100%)"}),i(`&.${t}-transition-leave-from`,{transform:"translateY(0)"}),i(`&.${t}-transition-leave-to`,{transform:"translateY(-100%)"})]}const Ve=i([c("drawer",`
