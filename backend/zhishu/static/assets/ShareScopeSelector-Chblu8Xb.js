...
`,[y("splitor",`
 ...
 `),M("checked",{color:"var(--n-button-text-color-hover)"})]),z("focus",[H("&:not(:active)",[y("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),z("checked",`
